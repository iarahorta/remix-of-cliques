...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Portal do cliente para acesso a serviços e atendimento online." },
      { name: "twitter:description", content: "Portal do cliente para acesso a serviços e atendimento online." },
