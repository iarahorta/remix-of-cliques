...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Encurte links, acompanhe cliques reais e distribua tráfego com rotação inteligente." },
      { name: "twitter:description", content: "Encurte links, acompanhe cliques reais e distribua tráfego com rotação inteligente." },
